...
var src_url_equal = function(element_src, url) {
...
// /home/jani/devel/web/personal/.buchta/output/index-tSOug0S.js
var add_css2 = function(target) {
  append_styles(target, "svelte-7qz18f", "@import url('https://fonts.googleapis.com/css2?family=Nunito+Sans:wght@500;700&display=swap');:root{--bg_h:#1d2021;--bg:#282828;--bg_s:#32302f;--bg1:#3c3836;--bg2:#504945;--bg3:#665c54;--bg4:#7c6f64;--fg:#fbf1c7;--fg1:#ebdbb2;--fg2:#d5c4a1;--fg3:#bdae93;--fg4:#a89984;--red:#fb4934;--green:#b8bb26;--yellow:#fabd2f;--blue:#83a598;--purple:#d3869b;--aqua:#8ec07c;--gray:#928374;--orange:#fe8019;--red-dim:#cc2412;--green-dim:#98971a;--yellow-dim:#d79921;--blue-dim:#458588;--purple-dim:#b16286;--aqua-dim:#689d6a;--gray-dim:#a89984;--orange-dim:#d65d0e}body{margin:0;padding:0;width:100vw;height:100vh;background-color:var(--bg_h)}.svelte-7qz18f.svelte-7qz18f.svelte-7qz18f{color:var(--fg);font-family:'Nunito Sans', sans-serif}main.svelte-7qz18f.svelte-7qz18f.svelte-7qz18f{display:flex;flex-direction:column;overflow-wrap:break-word;max-width:90vw;margin:auto;margin-top:25px;align-items:center}.projects.svelte-7qz18f.svelte-7qz18f.svelte-7qz18f{display:flex;gap:15px;flex-wrap:wrap}.projects.svelte-7qz18f>div.svelte-7qz18f.svelte-7qz18f{padding:7px;border-radius:7px;background-color:var(--bg);flex-grow:1;text-align:center;transition:all 150ms;cursor:pointer}.projects.svelte-7qz18f>div.svelte-7qz18f.svelte-7qz18f:hover{box-shadow:rgba(99, 99, 99, 0.2) 0px 2px 8px 0px}.projects.svelte-7qz18f>div.svelte-7qz18f>h3.svelte-7qz18f{font-weight:bold}");
};
...
var create_each_block2 = function(ctx) {
  ...
  return {
    ...
    h() {
      attr(h3, "class", "svelte-7qz18f");
      attr(p, "class", "svelte-7qz18f");
      attr(div, "class", "svelte-7qz18f");
    },
    m(target, anchor) {
...
var create_fragment2 = function(ctx) {
  ...
  let div1;
  let current;
  navbar = new navbar_pSFyCoc_default({ props: { pages: ctx[1] } });
  let each_value = ctx[0];
  let each_blocks = [];
  for (let i = 0;i < each_value.length; i += 1)
  ...
  return {
    c() {
      ...
      t1 = space();
      h1 = element("h1");
      t2 = text("Hello! I am J\xE1n Gajdo\u0161");
      t3 = space();
      div0 = element("div");
      t4 = space();
      h20 = element("h2");
      t5 = text("I am 17 year old high school student. I like to code and I spend sometimes a lot of time when coding in general. I am lazy type of a programmer. I am currently learning Data Structures and stuff that comes along with projects.");
      t6 = space();
      h21 = element("h2");
      t7 = text("Projects");
      t8 = space();
    ...
    l(nodes) {
      ...
      t2 = claim_text(h1_nodes, "Hello! I am J\xE1n Gajdo\u0161");
      ...
      t5 = claim_text(h20_nodes, "I am 17 year old high school student. I like to code and I spend sometimes a lot of time when coding in general. I am lazy type of a programmer. I am currently learning Data Structures and stuff that comes along with projects.");
      h20_nodes.forEach(detach);
      t6 = claim_space(main_nodes);
      h21 = claim_element(main_nodes, "H2", { class: true });
      var h21_nodes = children(h21);
      t7 = claim_text(h21_nodes, "Projects");
    ...
    h() {
      if (!src_url_equal(img.src, img_src_value = "https://avatars.githubusercontent.com/u/64907994"))
        attr(img, "src", img_src_value);
      attr(img, "alt", "My pfp");
      attr(img, "width", "256");
      attr(img, "loading", "lazy");
      attr(img, "class", "svelte-7qz18f");
      attr(h1, "class", "svelte-7qz18f");
      set_style(div0, "padding", "25px");
      attr(div0, "class", "svelte-7qz18f");
      attr(h20, "class", "svelte-7qz18f");
      attr(h21, "class", "svelte-7qz18f");
      attr(div1, "class", "projects svelte-7qz18f");
      attr(main, "class", "svelte-7qz18f");
      attr(div2, "class", "svelte-7qz18f");
    },
    m(target, anchor) {
...
var instance2 = function($$self) {
  const projects = [
    {
      t: "Buchta",
      d: "Bun-First integrable build step for frontend",
      s: "https://github.com/Fire-The-Fox/buchta"
    },
    {
      t: "AmethystDB",
      d: "Simple, Fast key-value pair database made in C",
      s: "https://github.com/Fire-The-Fox/AmethystDB"
    },
    {
      t: "Bun.nvim",
      d: "NeoVim plugin for Bun JavaScript runtime",
      s: "https://github.com/Fire-The-Fox/bun.nvim"
    },
    {
      t: "Foxnit",
      d: "Foxnit is a runit wrapper, something similar to systemctl, rc-update, etc.",
      s: "https://github.com/Fire-The-Fox/foxnit"
    },
    {
      t: "FireWM",
      d: "Custom Window Manager based on dwm",
      s: "https://github.com/Fire-The-Fox/FireWM"
    }
  ];
  const pages = [
    { t: "Home", s: "/" },
  ...
  const click_handler = (p) => location.href = p.s;
  return [projects, pages, click_handler];
};
...
var index_tSOug0S_default = Component2;
new Component2({ target: document.body, hydrate: true });
export {
  index_tSOug0S_default as default
};
